...
public class ContainerTrainWorkbench extends Container {
	...
	public void onCraftMatrixChanged(IInventory inv) {
		...
		craftResult.setInventorySlotContents(0, TrainCraftingManager.getInstance().func_82787_a(craftMatrix, world));
	}

	/*
	 * @Override public void updateCraftingResults() { super.updateCraftingResults(); craftResult.setInventorySlotContents(0, TrainCraftingManager.getInstance().func_82787_a(craftMatrix, world)); } */
