...
public class TilePDMInstructionRadio extends TileEntity implements IPeripheral, WirelessTransmitter, Environment, net.minecraft.util.ITickable {
    ...
    public ArrayList<WirelessTransmitter> getWirelessTransmittersInBoundingBox() {
      ...
      /*  List list = this.world.getEntitiesWithinAABBExcludingEntity(null, AxisAlignedBB.getBoundingBox(xCoord, yCoord, zCoord, xCoord + 100, yCoord +100, zCoord + 100));
        ...
        int cx = this.getPos().getX();
        int cy = this.getPos().getY();
        int cz = this.getPos().getZ();
        double radius = 50 * 16;
        ...
        for (Object obj : world.getEntitiesWithinAABB(Locomotive.class, searchBox)) {
