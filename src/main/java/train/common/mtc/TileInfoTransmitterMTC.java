...
public class TileInfoTransmitterMTC extends TileEntity implements IPeripheral, SimpleComponent {
    ...
    public void updateEntity() {
        ...
        List list = this.world.getEntitiesWithinAABBExcludingEntity(null, this.getRenderBoundingBox());
            ...
            for (Object obj : list) {
                ...
                //    daTrain.mtcStatus = MTCInfo;
				 ...
				 if (activated) {
                    ...
                    Traincraft.mscChannel.sendToAllAround(new PacketMTC(daTrain.getEntityId(), MTCInfo, 0) , new NetworkRegistry.TargetPoint(this.world.provider.getDimension(), daTrain.posX, daTrain.posY, daTrain.posZ, 150.0D));
