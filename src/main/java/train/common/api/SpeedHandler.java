...
public class SpeedHandler {
	...
	public static boolean isSpeedRailAt(World world, int i, int j, int k) {
		Block block = world.getBlockState(new net.minecraft.util.math.BlockPos(i, j, k)).getBlock();
	...
	private static float convertSpeed(Entity entity, float maxSpeed) {
		float speed = (float)(((Locomotive) entity).getMaxSpeed()*0.2775f);// speed is in m/s
