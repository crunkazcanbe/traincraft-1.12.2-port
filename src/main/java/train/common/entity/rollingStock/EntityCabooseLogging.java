...
public class EntityCabooseLogging extends AbstractWorkCart implements IInventory {
	...
	public void pressKey(int i) {
		if(locked && riddenByEntity != null && riddenByEntity instanceof EntityPlayer&& !((EntityPlayer)riddenByEntity).getDisplayName().getFormattedText().toLowerCase().equals(this.trainOwner.toLowerCase())){
			return;
		}
