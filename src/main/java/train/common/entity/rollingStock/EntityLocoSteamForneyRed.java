...
public class EntityLocoSteamForneyRed extends SteamTrain {
	...
	public void pressKey(int i) {
		if (i == 7 && riddenByEntity instanceof EntityPlayer) {
			((EntityPlayer) riddenByEntity).openGui(Traincraft.instance, GuiIDs.FORNEY, world, (int) this.posX, (int) this.posY, (int) this.posZ);
		}
	}
	...
	@Override
	public double getMaxSpeed() { return super.getMaxSpeed()*(getRidingEntity() instanceof EntityPlayerMP &&(((EntityPlayerMP) getRidingEntity()).getDisplayName().getFormattedText().equals("EternalBlueFlame") || ((EntityPlayerMP) getRidingEntity()).getDisplayName().getFormattedText().equals("minecarftmano9"))?3f:1f);}

	@Override
	public int getPower() {
		return super.getPower()*(getRidingEntity() instanceof EntityPlayerMP &&(((EntityPlayerMP) getRidingEntity()).getDisplayName().getFormattedText().equals("EternalBlueFlame") || ((EntityPlayerMP) getRidingEntity()).getDisplayName().getFormattedText().equals("minecarftmano9"))?3:1);
	}
}