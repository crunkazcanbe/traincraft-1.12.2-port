...
public class EntityTenderBR_Black_5 extends Tender implements IInventory  {
    ...
    public EntityTenderBR_Black_5(World world) {
        super(world, FluidRegistry.WATER, 0, EnumTrains.tender_BR_Black_5.getTankCapacity(), LiquidManager.WATER_FILTER);
        initFreightTender();
    }
    ...
    public boolean processInitialInteract(EntityPlayer entityplayer, net.minecraft.util.EnumHand hand) {
        ...
        if (!this.world.isRemote) {
            entityplayer.openGui(Traincraft.instance, GuiIDs.TENDER, world, this.getEntityId(), -1, (int) this.posZ);
        }
        return true;
    }
