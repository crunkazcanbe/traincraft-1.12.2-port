...
public class Traincraft {
	...
	public ArmorMaterial armorCompositeSuit = EnumHelper.addArmorMaterial("TCsuit", "traincraft:tcsuit", 70, new int[] {2, 6, 5, 2}, 50, net.minecraft.init.SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
	...
	public void load(FMLInitializationEvent event) {
		...
		// NOTE: VillagerRegistry dropped the old int-villagerId-based registerVillagerId/
		// registerVillageTradeHandler methods in favor of a VillagerProfession/VillagerCareer
		// forge-registry system; a full port of the custom trades to that system is out of
		// scope here, so only the village-generation piece (the station building) is kept.
	...
	public class tcAdminPerm extends CommandBase {
		...
		@Override
		public void execute(net.minecraft.server.MinecraftServer server, ICommandSender CommandSender, String[] par2ArrayOfStr) throws PlayerNotFoundException {
			getCommandSenderAsPlayer(CommandSender).sendMessage(
