...
public class TileMFPBWigWag extends TileTraincraft implements ITickable {
    ...
    public void update() {
        ...
        if (world.isRemote) {
            if (rotation > 20 || rotation < -20) {
                flip = !flip;
                world.playSound(null, pos, net.minecraft.util.SoundEvent.REGISTRY.getObject(new net.minecraft.util.ResourceLocation(Info.modID + ":" + "bell")), net.minecraft.util.SoundCategory.BLOCKS, 1f, 1f);
            }
            ...
            if (updateTicks % 20 == 0) {
                ...
                if (!world.isAirBlock(above)) {
                    ...
                    if (block != null) {
                        EntityItem entityitem = new EntityItem(world, pos.getX(), pos.getY() + 1, pos.getZ(), new ItemStack(Item.getItemFromBlock(BlockIDs.MFPBWigWag.block), 1));
                        float f3 = 0.05F;
