 ...
 */
public class TileEntityOverheadLines extends TileEntity implements ITickable {
...
/*
		...
		List lis3 = this.world.getEntitiesWithinAABB(ElectricTrain.class, AxisAlignedBB.getBoundingBoxFromPool((double)this.pos.getX(), (double)this.pos.getY(), (double)this.pos.getZ(), (double)(this.pos.getX() + 1), (double)(this.pos.getY() + 1), (double)(this.pos.getZ() + 1)).expand(1.0D, 4.0D, 1.0D));
		...
		List lis1 = this.world.getEntitiesWithinAABB(EntityPlayer.class, AxisAlignedBB.getBoundingBoxFromPool((double)this.pos.getX(), (double)this.pos.getY(), (double)this.pos.getZ(), (double)(this.pos.getX() + 0.1), (double)(this.pos.getY()+0.1), (double)(this.pos.getZ() + 0.1)).expand(1.2D, 1.2D, 1.2D));
*/
	}
	public double getDistanceSq(double par1, double par3, double par5) {
		double var7 = this.pos.getX() - par1;
		double var9 = this.pos.getY() - par3;
		if (Math.abs(var9) == 1)
			var9 = 0;
		double var11 = this.pos.getZ() - par5;
