...
public class TilecircleSwitchStand extends TileTraincraft implements ITickable {
        ...
        if (!world.isRemote) {
            if (updateTicks % 20 == 0) {
                ...
                if (!world.isAirBlock(above)) {
                    ...
                    if (block != null) {
                        EntityItem entityitem = new EntityItem(world, pos.getX(), pos.getY() + 1, pos.getZ(), new ItemStack(Item.getItemFromBlock(BlockIDs.circleSwitchStand.block), 1));
                        float f3 = 0.05F;
