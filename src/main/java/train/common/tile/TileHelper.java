...
public class TileHelper {
	...
	public static EnumFacing getOrientationFromSide(EnumFacing front, EnumFacing side) {
		if (front != EnumFacing.UP && side != EnumFacing.UP) {
			switch (front.ordinal()) {
			case 0:
				switch (side.ordinal()) {
				case 0:
					return EnumFacing.byIndex(3);
				case 1:
					return EnumFacing.byIndex(2);
				case 2:
					return EnumFacing.byIndex(1);
				case 3:
					return EnumFacing.byIndex(0);
				case 4:
					return EnumFacing.byIndex(5);
				case 5:
					return EnumFacing.byIndex(4);
				}
