...
public class GUIAdminBook extends GuiScreen {
    ...
    private void func_146977_a(ItemStack p_146977_1_, int xDisplayPosition, int yDisplayPosition) {
        ...
        mc.getRenderItem().renderItemAndEffectIntoGUI(p_146977_1_, xDisplayPosition, yDisplayPosition);
        mc.getRenderItem().renderItemOverlayIntoGUI(this.fontRenderer, p_146977_1_, xDisplayPosition, yDisplayPosition, null);
