...
public class SoundUpdaterRollingStock {
	...
	public void update(SoundHandler par1SoundManager, EntityRollingStock rollingStock, EntityPlayerSP par3EntityPlayerSP) {
		...
		//System.out.println((float) Math.sqrt(this.theMinecart.getMotionXClient()*this.theMinecart.getMotionXClient()+this.theMinecart.getMotionZClient()*this.theMinecart.getMotionZClient())/100);
		this.cartSpeed = (float) Math.sqrt(this.theMinecart.getMotionXClient() * this.theMinecart.getMotionXClient() + this.theMinecart.getMotionZClient() * this.theMinecart.getMotionZClient()) / 100;
