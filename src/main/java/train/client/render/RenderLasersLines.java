...
public class RenderLasersLines extends Render<EntityLasersLines> {
	/** instance of ModelBoat for rendering */
	private static final ModelBase model = new ModelBase() {};
	private ModelRenderer box;

	public RenderLasersLines(net.minecraft.client.renderer.entity.RenderManager rm) {
		super(rm);
	 ...
	 */
	@Override
	public void doRender(EntityLasersLines entity, double par2, double par4, double par6, float par8, float par9) {
		this.renderLasersLines(entity, par2, par4, par6, par8, par9);
	}

	@Override
	protected ResourceLocation getEntityTexture(EntityLasersLines entity) {
		return null;
	}
}
