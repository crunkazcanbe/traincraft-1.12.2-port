...
public class RenderZeppelins extends Render<AbstractZeppelin> {
	...
	public RenderZeppelins(net.minecraft.client.renderer.entity.RenderManager rm) {
		super(rm);
		shadowSize = 0.5F;
	}
	...
	@Override
	public void doRender(AbstractZeppelin entity, double d, double d1, double d2, float f, float f1) {
		func_157_a(entity, d, d1, d2, f, f1);
	}

	@Override
	protected ResourceLocation getEntityTexture(AbstractZeppelin entity) {
