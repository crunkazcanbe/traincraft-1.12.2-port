...
public class GuiTCTextField extends Gui {
	...
	private void drawCursorVertical(int par1, int par2, int par3, int par4) {
		...
		bufferbuilder.pos((double) par1, (double) par4, 0.0D).endVertex();
		bufferbuilder.pos((double) par3, (double) par4, 0.0D).endVertex();
		bufferbuilder.pos((double) par3, (double) par2, 0.0D).endVertex();
		bufferbuilder.pos((double) par1, (double) par2, 0.0D).endVertex();
		tessellator.draw();
