...
public class GuiSpeedTransmitter extends GuiScreen {
   ...
   @Override
    ...
    protected void actionPerformed(GuiButton button) throws java.io.IOException {
        if (button.id == 0) {
            net.minecraft.util.math.BlockPos tPos = transmitterBlock.getPos();
            TileInfoTransmitterSpeed its = (TileInfoTransmitterSpeed)transmitterBlock.getWorld().getTileEntity(tPos);
            its.setSpeed =Integer.parseInt(speedLimitTextField.getText());
            Traincraft.itsChannel.sendToServer(new PacketSetSpeed(Integer.parseInt(speedLimitTextField.getText()), tPos.getX(), tPos.getY(), tPos.getZ(), 0));
            ...
            Traincraft.itnsChannel.sendToAll(new PacketNextSpeed( Integer.parseInt(nextSpeedLimitTextField.getText()), tPos.getX(), tPos.getY(), tPos.getZ(), Double.parseDouble(nextSpeedXTextField.getText()),   Double.parseDouble(nextSpeedYTextField.getText()),  Double.parseDouble(nextSpeedZTextField.getText()), 0));
        }
